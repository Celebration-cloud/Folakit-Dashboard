    ...
    >
      ...
      <div className={`${styles.address} grid grid-cols-2 gap-6 mb-6`}>
        <div>
          ...
          <p className="text-muted-foreground">{item.address.address}</p>
          <p className="text-muted-foreground">{item.address.city}</p>
      ...
      <table className="w-full text-left border-collapse mb-6">
        ...
        <tbody>
          {item.cart.map((product, idx) => (
            <tr
              key={idx}
              style={{ borderColor: "black", borderBottom: "2px black" }}
            >
              <td className="p-3 border-b">{idx + 1}</td>
              <td className="p-3 border-b">{product.product}</td>
              <td className="p-3 border-b">&#x20A6;{product.price.toLocaleString}</td>
              <td className="p-3 border-b">&#x20A6;{product.amount.toLocaleString()}</td>
