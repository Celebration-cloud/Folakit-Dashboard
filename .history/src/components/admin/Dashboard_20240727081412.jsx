  ...
  return (
    ...
    <div class="bg-background text-primary-foreground min-h-screen p-8">
      <div class="flex flex-col md:flex-row items-center justify-between mb-8">
        <h1 class="text-3xl font-bold mb-4 md:mb-0 md:mr-8">Admin Dashboard</h1>
        <button class="bg-primary text-primary-foreground px-4 py-2 rounded-lg hover:bg-primary/80">
          Sign Out
        </button>
      </div>
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div class="bg-secondary text-secondary-foreground p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
          <h2 class="text-xl font-semibold mb-2">Total Customers</h2>
          <p class="text-3xl font-bold">1,234</p>
        </div>
        <div class="bg-accent text-accent-foreground p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
          <h2 class="text-xl font-semibold mb-2">Total Orders</h2>
          <p class="text-3xl font-bold">5,678</p>
        </div>
        <div class="bg-destructive text-destructive-foreground p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
          <h2 class="text-xl font-semibold mb-2">Total Products</h2>
          <p class="text-3xl font-bold">987</p>
        </div>
        <div class="bg-muted text-muted-foreground p-6 rounded-lg col-span-1 md:col-span-2 lg:col-span-3 shadow-lg">
          <h2 class="text-xl font-semibold mb-4">Other Highlights</h2>
