    ...
    <div className="flex items-center justify-center min-h-screen bg-background">
      ...
      <div className="bg-card shadow-lg rounded-lg p-8 max-w-md w-full md:w-1/2">
        ...
        <form>
          ...
          <button
            type="submit"
            className="w-full bg-primary texto-zinc-50 text-primary-foreground p-3 rounded-lg hover:bg-primary/80 focus:outline-none focus:ring focus:ring-primary transition duration-200"
          >
            Login
          </button>
        </form>
